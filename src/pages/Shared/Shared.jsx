...
const Shared = () => {
  ...
  return (
    <>
      <SEO
        title="Shared Files - Gofilez"
        keywords="shared files, cloud storage, file sharing, secure storage"
        description="View and manage all shared files in Gofilez cloud storage"
      />
      <Box sx={{ padding: 4 }}>
        <Typography
